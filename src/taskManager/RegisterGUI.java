...
/**
 * class RegisterGUI for registering to to_do_list 
 */
...
class RegisterGUI extends JFrame {
    ...
    private void initializeGUI() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("Register for TO-DO LIST", JLabel.CENTER);
        ...
        registerButton.setBounds(50, 220, 140, 40);
        styleButtonWithBorder(registerButton, new Color(0, 153, 76)); // Green button
        getContentPane().add(registerButton);

        // Back Button
        JButton backButton = new JButton("Back to Login");
        backButton.setBounds(220, 220, 140, 40);
        styleButtonWithBorder(backButton, new Color(0, 102, 204)); // Blue button
        ...
        registerButton.addActionListener(e -> {
            ...
            if (userDB.registerUser(username, password)) {
                ...
                new LoginGUI(); // Navigate back to login after successful registration
                dispose();
            } else {
    ...
    /**
     * Creates a rounded border for text fields and password fields
     */
